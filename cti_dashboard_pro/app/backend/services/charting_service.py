"""
charting_service.py — Matplotlib charting logic for CTI Dashboard Pro.

Handles the generation of ATC-105 cross plots and converts them to base64 PNG images
to be embedded directly into PDF reports or served via API.
"""
...
# ─────────────────────────────────────────────────────────────────────────────
# Shared matplotlib style constants
# ─────────────────────────────────────────────────────────────────────────────
...
def create_cross_plot_1(cp1: dict, label: str = "") -> str:
    """
...
def create_cross_plot_2(cp2: dict, label: str = "") -> str:
    """
...
def create_blank_plot(title: str) -> str:
