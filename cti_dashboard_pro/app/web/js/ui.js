...
import { fetchAndRenderBaseComparison, renderMarginComparison, renderMarginTable, bindMarginModalState } from './ui/report/report-margin.js';
...
export const ui = {
    ...
    fetchAndRenderBaseComparison: () => fetchAndRenderBaseComparison(ui),
    renderMarginComparison: () => renderMarginComparison(ui),
    _renderMarginTable: () => renderMarginTable(ui)
};

// ── Margin Modal global state & toggle handlers ────────────────────────────
bindMarginModalState(ui);
